...
# @dataclass(frozen=True)
# class STRONGSORTArgs:
#     ecc: bool = True
#     ema_alpha: float = 0.8962157769329083
#     max_age: int = 40
#     max_dist: float =0.1594374041012136
#     max_iou_dist:float = 0.5431835667667874
#     max_unmatched_preds:int = 300
...
#     # byte_tracker = BYTETracker(BYTETrackerArgs())
#     # print('\n\n\n trackerloaded \n\n\n')
#     strong_sort_tracker = StrongSORT(Path('osnet_x0_25_msmt17.pt'),
#                                     'cpu',
#                                     False,
#                                     STRONGSORTArgs())
#     tracker = strong_sort_tracker
#     print('\n\n\n strong sort loaded \n\n\n')
...
#         # tracker_id = match_detections_with_tracks(detections=detections, tracks=tracks)
#         detections.tracker_id = np.array(tracks[4])
